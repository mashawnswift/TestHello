...
void Exercise::CreateMyEntitity(wstring entityName, wstring baseObjetcName)
{
	...
	//incrfemintinng the index in order to create unique name
	...
	//take the current location from the contrlled entity
	Location  Loc;
	LinearVec Vec;
	...
	//init the new aircrat with the controlled entity location
